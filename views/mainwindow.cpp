    ...
    ui(new Ui::MainWindow)
{
    ...
    //jerry
//    QObject::connect(viewSettingsWidget(),SIGNAL(Signal_button_connect(int,bool)),RTLSDisplayApplication::client(), SLOT(Slot_button_connect(int,bool)));
//    QObject::connect(viewSettingsWidget(),SIGNAL(Signal_button_send(QByteArray)),RTLSDisplayApplication::client(), SLOT(Slot_button_send(QByteArray)));

//    QObject::connect(RTLSDisplayApplication::client(),SIGNAL(Signal_Sever_State(bool)),viewSettingsWidget(), SLOT(Slot_Sever_State(bool)));
//    QObject::connect(RTLSDisplayApplication::client(),SIGNAL(Signal_Client_Disconnect()),viewSettingsWidget(), SLOT(Slot_Client_Disconnect()));
//    QObject::connect(RTLSDisplayApplication::client(),SIGNAL(Signal_Client_Connect()),viewSettingsWidget(), SLOT(Slot_Client_Connect()));
//    QObject::connect(RTLSDisplayApplication::client(),SIGNAL(Signal_Client_Recvdata(QByteArray)),viewSettingsWidget(), SLOT(Slot_Client_Recvdata(QByteArray)));
//liwenfneg
QObject::connect(viewSettingsWidget(),SIGNAL(sendchuandi(QByteArray,int)),RTLSDisplayApplication::client(), SLOT(slotchuandi(QByteArray,int)));
    //
